...
def build_fancysale_cleanup_query(
    stuck_minutes: int,
    context: Optional[ExecutionContext] = None,
    active_refs: Optional[Set[Any]] = None,
) -> Tuple[str, dict]:
    """Construct stuck-record cleanup query Q005 and parameter dictionary.
...
class FancySaleAdapter:
    ...
    def reset_stuck_processing(
        ...
        """Emergency reset: move stuck CAF_ENTRY_DONE='P' records back to 'N'.
